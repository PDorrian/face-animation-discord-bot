...
4) **Taichi**. Follow the instructions in [data/taichi-loading](cogs/deep/data/taichi-loading/README.md) or instructions from https://github.com/AliaksandrSiarohin/video-preprocessing. 
...
```
>>>>>>> parent of cdd7f65 (updated readme)
